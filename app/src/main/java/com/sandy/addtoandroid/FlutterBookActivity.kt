...
import com.sandy.addtoandroid.BookApplication.Companion.ENGINE_ID
...
class FlutterBookActivity : FlutterActivity() {
    ...
    class CachedEngineBookIntentBuilder(engineId: String) :
        CachedEngineIntentBuilder(FlutterBookActivity::class.java, engineId) {}
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        val bookToShow =
            Api.Book.fromMap(intent.getSerializableExtra(EXTRA_BOOK) as HashMap<String, Any>)
